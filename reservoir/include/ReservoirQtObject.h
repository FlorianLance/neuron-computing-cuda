...
/**
 * \file ReservoirQtObject.h
 * \brief defines Reservoir
 * \author Florian Lance
 * \date 02/12/14
 */

#ifndef RESERVOIRQTOBJECT_H
#define RESERVOIRQTOBJECT_H
...
/**
 * @brief The ReservoirQt class
 */
class ReservoirQt  : public QObject
{
    ...
    public :
         ...
         * @param verbose
         */
        ReservoirQt(cuint nbNeurons, cfloat spectralRadius, cfloat inputScaling, cfloat leakRate, cfloat sparcity = -1.f, cfloat ridge = 1e-5f, cbool verbose = true);
