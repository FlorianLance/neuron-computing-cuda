...
ReservoirObject::ReservoirObject()
{
    m_initialized = false;
    m_verbose = true;
...
void ReservoirObject::setCudaProperties(cbool cudaInv, cbool cudaMult)
{
...
ReservoirObject::ReservoirObject(cuint nbNeurons, cfloat spectralRadius, cfloat inputScaling, cfloat leakRate, cfloat sparcity, cfloat ridge, cbool verbose) :
...
void ReservoirObject::generateMatrixWF()
{
    // debug
...
void ReservoirObject::generateWInF(cuint dimInput)
{
    // debug
...
void ReservoirObject::tikhonovRegularizationF(const cv::Mat &xTot, const cv::Mat &yTeacher, cuint dimInput)
{
...
void ReservoirObject::trainF(const cv::Mat &meaningInputTrain, const cv::Mat &teacher, cv::Mat &sentencesOutputTrain, cv::Mat &xTot)
{
    m_oTime = clock();
...
void ReservoirObject::testF(const cv::Mat &meaningInputTest, cv::Mat &sentencesOutputTest, cv::Mat &xTot)
{
