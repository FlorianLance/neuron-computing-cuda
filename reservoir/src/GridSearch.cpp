...
void GridSearch::launchTrainWithAllParameters(const std::string resultsFilePath, const std::string resultsRawFilePath)
{
    ...
    int l_nbCharParams[] = {11,9,11,10,15,9,17,10,11,11,11,11};//,11,11};
...
bool GridSearch::setParameterValues(const GridSearch::ReservoirParameter parameterId, cdouble startValue, cdouble endValue, const std::string operation)
{
